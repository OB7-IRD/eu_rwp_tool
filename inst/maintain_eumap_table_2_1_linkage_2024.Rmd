...
Highlights known issues with input data. These should only be included in the control file, not table 2.1

(This needs to come after the work with area, so e.g. too high area levels are not corrected by the area loops above)

```{r, eval = F}

her_28 <- as.data.frame(region = "Baltic Sea",
                        spp_name = "Herring",
...
linkage_3 <- rbind(linkage_2, her_28)
